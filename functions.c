...
/**
 * pall - is a function that prints all the elements of a
 * dlistint_t list.
...
/**
 * pint - is a function that prints all the elements of a
 * dlistint_t list.
 * @h: A pointer to the beginig of the list
 * Return: The number of elements in the list
 */
...
/**
 * pop -  a function that deletes the
...
/**
 * swap -  a function that deletes the
 * node at index index of a dlistint_t linked list.
 * @head: the pointer to the direction of the list.
 * Return: 1 if it works or -1 if don't
 */
